...
mod.add_module_function(alias = "temp",     function = bme.read_temperature)
mod.add_module_function(alias = "hum",      function = bme.read_humidity)
mod.add_module_function(alias = "pressure", function = bme.read_pressure)
